...
//CPPUNIT_TEST_SUITE_REGISTRATION( ModifyTest ); // Note 4 
//
//
//void ModifyTest::testInsert(){
//
//	Modify modifyObj;
//	
//	// verify that the insertion is correct - Note 7
//	int result1 = modifyObj.insertModifies(1,2);
//	int result2 = modifyObj.insertModifies(2,3);
//
//	CPPUNIT_ASSERT_EQUAL(99, result1);
//	CPPUNIT_ASSERT_EQUAL(99, result2);
//
//	int result3 = modifyObj.insertModifies(1, 2);
//
